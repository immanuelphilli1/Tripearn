...
const PaymentErrorPage = () => {
  return (
    <main className=" flex justify-center min-h-screen items-center text-red  flex-col" >
      ...
      <div className="text-4xl text-white pt-4">Payment error!</div>
      <div className="text-2xl text-white pt-2">Your payment was unsuccessful. Please ensure that you have enough funds available and try again!</div>
